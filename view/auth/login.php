...
<body class="bg-[#1e203b] text-white">
    ...
    <div class="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 w-full max-w-sm px-4">
            <?php
                if (!isset($fieldErrors)) $fieldErrors = ['nim' => false, 'password' => false];
                if (!isset($shake)) $shake = false;
            ...
            <div id="login-card" class="bg-[#2a2c4e] p-8 rounded-2xl shadow-lg <?php echo $shake ? 'shake' : ''; ?>">
                ...
                <form id="login-form" action="index.php?action=doLogin" method="POST" novalidate>
                    ...
                    <?php if ($error): ?>
                        <div id="server-error" class="text-sm text-red-300 mb-4"><?php echo htmlspecialchars($error); ?></div>
                    <?php endif; ?>
                    ...
                    >
                        LOG IN
                        <span class="ml-2 bg-blue-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs">
                            &#10003;
                        </span>
                    </button>
                </form>
